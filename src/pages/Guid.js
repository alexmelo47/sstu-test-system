        ...
        <div className="home">
            <div className="content-block-home">
                ...
                <span>
                    ...
                    <h4>Вход в систему и переходы по страницам.</h4><br /><br />
                    ...
                    <p>3. Нажмите кнопку "<Button color="primary">Авторизоваться</Button>".</p>
                    ...
                    <p>3. Нажмите кнопку "<Button color="primary">Напомнить данные</Button>" и пройдите авторизацию после получения письма с напоминанием на почту.</p><br />
                    
                    <h3>Для регистрации в системе, следуйте данным указаниям:</h3>
                    <p>1. Нажмите в форме авторизации на кнопку "<Button color="primary">Заявка на регистрацию</Button>"</p>
                    <p>2. В появившейся форме заполните поля ФИО, электронная почта, дату рождения, а также вашего статуса в системе.</p>
                    <p>3. Нажмите кнопку "<Button color="primary">Отправить заявку</Button>" и ожидайте получения письма на указанную при регистрации электронную почту с данными для авторизации.</p><br />
                    ...
                    <p>3. В открывшейся форме с подробной информацией о выбранном тесте нажмите кнопку "<Button color="primary">Начать тестирование</Button>".</p>
                    <p>Если вы передумали, нажмите в форме кнопку "<Button color="primary">Закрыть</Button>" и выберите другой тест.</p><br />

                    <h3>Пример представления страницы с запущенным тестом:</h3><br /><br />
